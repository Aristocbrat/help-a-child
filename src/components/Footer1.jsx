  ...
  return (
    <div>
      ...
      <div className='text-center'>
        <p className=' sm:text-[12px] md:text-2xl lg:text-3xl xl:text-lg py-10'>
        ...
        <p className='hearts text-red-600 flex justify-center text-[10px] md:text-3xl lg:text-3xl xl:text-lg  animate-pulse py-4'>
