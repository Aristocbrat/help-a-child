...
const Footer1 = () => {
  return (
    <div>
      ...
      <div className='text-center'>
        <p className=' text-lg md:text-2xl lg:text-3xl xl:text-2xl py-10'>
        ...
        <p className='hearts text-red-600 flex justify-center text-lg md:text-3xl lg:text-3xl xl:text-3xl  animate-pulse py-4'>
  ...
  <button className='bg-black text-white border border-neutral-50 p-4 rounded-[9px] font-bold'>
    Click Here
        ...
        <p className='gtext text-xl md:text-2xl lg:text-3xl xl:text-3xl py-4'>
