  ...
  return (
    <div>
      <div className="couns px-4">
        <h1 className='uppercase font-semibold text-3xl py-2 seperation flex justify-center'>Counseling Services</h1>
      ...
      <section className='w-[70%]'>
        <h1 className='uppercase font-semibold text-3xl py-3 seperation flex px-5'>Why Counseling Matters</h1>
      ...
      <div className="help font-semibold px-5 w-[70%]">
      <h1 className='uppercase  text-3xl py-3 seperation flex px-5'>Counseling helps children:</h1>
      <ul>
      ...
      <div className="services font-semibold w-[70%] px-5">
      <h1 className='uppercase  text-3xl py-3 seperation flex '>Our Counseling Services</h1>
      <div className="cases py-2">
        <h1>Individual Counseling:</h1>
        <p className='w-[590px]'>One-on-one sessions with licensed therapists to address specific emotional and psychological needs.</p>
      </div>
      <div className="cases py-2">
        <h1>Group Therapy:</h1>
      ...
      <section className='bg-black rounded-l-[50%] w-[45%] h-[600px] text-white absolute right-4 mt-[-65%] '>
      <h1 className='uppercase  text-lg font-bold py-6  flex justify-center ml-[15%] px-8 mt-6 '> How to Access Counseling Services</h1>
      <div className="cases py-2 w-[400px] ml-[19%]" data-aos="slide-left">
        <h1 className='text-2xl'> <i className="ri-arrow-right-double-fill"></i> For Children in Our Care:</h1>
      ...
      <div className="cases py-2 w-[400px] ml-[26%]" data-aos="slide-right">
        <h1 className='text-2xl'> <i className="ri-arrow-right-double-fill"></i>For Adoptive and Foster Families:</h1>
      ...
      <div className="cases py-2 w-[400px] ml-[34%]" data-aos="slide-right">
        <h1 className='text-2xl'> <i className="ri-arrow-right-double-fill"></i> Community Outreach:</h1>
