...
const Aboutus = () => {
  return (
    <div className=' w-full h-full xl:px-6 sm:px-3'>
      ...
      <span className='uppercase font-bold xl:text-5xl sm:text-lg xl:mt-[-5%] xl:ml-[15%] sm:ml-[33%]  sm:mt-[-15%] absolute'>Who we are ?</span>
      ...
      <section className='mt-[4%] bg-black  text-white' >
        <div className="guestspeakers flex xl:flex-row sm:flex-col gap-5 px-7 py-5">
          ...
          <img src={guest2} alt=""  className='w-[400px] rounded-[20px]' data-aos="flip-left"/>
          <p className='xl:w-[370px] border-2 py-3 border-solid border-gray-200 px-4 rounded-[10px] mt-3'>At CWOALG Orphanage, we are thrilled to host events featuring inspiring guest speakers who bring valuable insights and encouragement to
