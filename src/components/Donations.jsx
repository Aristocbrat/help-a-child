  ...
  return (
    <div className=' bg-slate-400 max-w-[100%] h-[100vh] text-white flex items-center align-middle  justify-center'>
      ...
      <div className="container w-[50%] h-[70%] relative rounded-[6px] bg-[black] overflow-hidden shadow-sm">
        <h1 className='absolute text-lg md:text-2xl lg:text-3xl xl:text-6xl font-bold p-[20px] mt-5 text-center w-[100%]'>Sign Up</h1>
        <div className="indicator flex items-center align-middle top-[20%] text-2xl md:2xl lg:4xl xl:text-4xl justify-center absolute w-[100%] h-[50px] ">
        ...
        <div className="panel relative w-[100%] h-[100%] top-0 left-0 transition-all duration-400 ease">
          <div className="page1 absolute w-[500px] h-[100%] left-[25%] ">
          ...
          <div className="page2 absolute w-[500px] h-[100%] left-[96%]">
            <form action="#" className="form absolute items-center justify-center flex flex-col w-[100%] h-[100%] top-[90px]">
          ...
          <div className="page3 absolute w-[300px] h-[100%] left-[166%] ">
          ...
          <div className="page4 absolute w-[500px] h-[100%] left-[250%]">
            <form action="#" className="form absolute items-center justify-center flex flex-col w-[100%] h-[100%] top-[90px]">
              <h2>Login Details</h2>
              <div className="form-group">
                <input type="text" required className='text-black' />
