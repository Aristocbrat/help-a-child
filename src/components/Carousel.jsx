...
const Carousel = () => {
 ...
 const goToSlide= (slideIndex) =>{
  ...
  return (
    <div>
       <div className='max-w-[70%] min-w-36 relative py-20 mx-auto h-[700px] min-h-36 px-6 group'>
  ...
  <div className="edu py-20 ps-5 border-r-4 border-black flex items-center justify-center flex-col">
    ...
    <p className='' data-aos='fade-down-right'>-Send more children to school and be a part of their success story. </p>
  ...
  <div className="edu py-20 ps-5 border-r-4 border-black flex items-center justify-center flex-col">
    ...
    <p data-aos='fade-down-right'>-Feed more cildren and make them smile. </p>
    <p className='font-bold text-2xl' data-aos='fade-down-right'>Help a chid today. </p>
    <a href="" className='mt-12 hover:scale-110 hover:bg-black hover:text-white transition-transform duration-300 hover:px-8 hover:rounded'>www.Cwoalg.com</a>
  </div>
  <div className="edu py-20 ps-5 border-r-4 border-black flex items-center justify-center flex-col">
    <img src={walk} alt="" className="w-[95%] h-40 object-cover px-8 "/>
     <p data-aos='fade-down-right'>-Join our monthly awareness march to sensitize the public.</p>
     <p className='font-bold text-2xl' data-aos='fade-down-right'>Help a chid today. </p>
     <a href="" className='mt-12 hover:scale-110 hover:bg-black hover:text-white transition-transform duration-300 hover:px-8 hover:rounded'>www.Cwoalg.com</a>
  </div>
  <div className="edu py-20 ps-5 border-r-4 border-black flex items-center justify-center flex-col">
    <img src={boyandgirl} alt="" className="w-[95%] h-40 object-cover px-8" />
    <p data-aos='fade-down-right' className='px-3'>-Help make a family , no child deserves to be alone .</p>
    <p className='font-bold text-2xl' data-aos='fade-down-right'>Help a chid today. </p>
    <a href="" className='mt-12 hover:scale-110 hover:bg-black hover:text-white transition-transform duration-300 hover:px-8 hover:rounded'>www.Cwoalg.com</a>
  </div>
</div>
